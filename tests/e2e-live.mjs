...
await page.locator('[data-v9-quick]').evaluate(b=>b.click());await page.waitForSelector('#v9-modal.show #v9-quick-form',{timeout:5000});await page.locator('#v9-modal [data-v9-close]').first().click();

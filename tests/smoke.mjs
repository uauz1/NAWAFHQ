...
new Script(app);new Script(agent);new Script(executor);new Script(apps);new Script(cloud);new Script(icons);new Script(finance);new Script(quality);new Script(ops);new Script(ceo);
for(const asset of ['hq-shell-v8.css','hq-shell-v8.js','hq-agent-runtime.js','hq-project-executor.js','hq-executive-secretary.js','hq-cloud-sync.js','hq-icons-v10.css','hq-icons-v10.js','hq-finance-v1.js','hq-quality-v11.css','hq-quality-v11.js','hq-ops-v12.css','hq-ops-v12.js','hq-ceo-v13.css','hq-ceo-v13.js'])if(!html.includes(asset))throw new Error(`Missing asset ${asset}`);
...
if(!css.trim()||!iconsCss.trim()||!qualityCss.trim()||!opsCss.trim()||!ceoCss.trim())throw new Error('Production stylesheet empty');
console.log('Nawaf HQ V13 CEO decisions + V12 operations + V11 quality + finance + cloud sync + permissions smoke checks passed');

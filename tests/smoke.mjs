...
new Script(app);new Script(agent);new Script(executor);new Script(apps);new Script(cloud);new Script(icons);new Script(finance);
for(const asset of ['hq-shell-v8.css','hq-shell-v8.js','hq-agent-runtime.js','hq-project-executor.js','hq-executive-secretary.js','hq-cloud-sync.js','hq-icons-v10.css','hq-icons-v10.js','hq-finance-v1.js'])if(!html.includes(asset))throw new Error(`Missing asset ${asset}`);
...
if(!css.trim()||!iconsCss.trim())throw new Error('Production stylesheet empty');
console.log('Nawaf HQ V10 + financial analyst + Cloud Sync V2 + permissions smoke checks passed');

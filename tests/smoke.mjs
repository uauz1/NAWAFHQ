...
new Script(app);new Script(agent);new Script(executor);new Script(apps);new Script(cloud);new Script(icons);
for(const asset of ['hq-shell-v8.css','hq-shell-v8.js','hq-agent-runtime.js','hq-project-executor.js','hq-executive-secretary.js','hq-cloud-sync.js','hq-icons-v10.css','hq-icons-v10.js'])if(!html.includes(asset))throw new Error(`Missing asset ${asset}`);
...
console.log('Nawaf HQ V10 visual + Cloud Sync V2 + permissions smoke checks passed');

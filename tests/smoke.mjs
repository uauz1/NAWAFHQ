...
new Script(app);new Script(agent);new Script(executor);new Script(apps);new Script(cloud);new Script(icons);new Script(finance);new Script(quality);new Script(ops);new Script(ceo);new Script(dash);new Script(companyOs);new Script(companyOsV23);new Script(secretary);
